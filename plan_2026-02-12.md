...
- Remaining benchmark work:
  - Run baseline with explicit torch/runtime availability and longer/adjusted budget.
  - Capture GPU timing and compute throughput ratios from comparable artifacts.
- Phase 2.1 is therefore partially complete: benchmark harness execution plumbing and script-level artifacts are working; full baseline-comparison evidence still pending.
